                ...
                >
                  <PerfectScrollbar style={{ height: 320, overflowX: 'hidden' }}>
                    ...
                    <ListItemButton alignItems="flex-start" sx={{ pt: 0 }}>
                      ...
                      <ListItemText
                        primary={<Typography variant="subtitle1">[Dev] Gab</Typography>}
                        secondary={<Typography variant="subtitle2">New feature Added</Typography>}
                      />
                    ...
                    <ListItemButton alignItems="flex-start" sx={{ pt: 0 }}>
                      ...
                      <ListItemText
                        primary={<Typography variant="subtitle1">[Dev] Drake</Typography>}
                        secondary={<Typography variant="subtitle2">Added a new announcement</Typography>}
                      />
                    ...
                    <ListItemButton alignItems="flex-start">
                      ...
                      <ListItemText
                        primary={<Typography variant="subtitle1">[Dev] Kiel </Typography>}
                        secondary={<Typography variant="subtitle2">Updated job listings</Typography>}
                      />
                    ...
                    <ListItemButton alignItems="flex-start">
                      ...
                      <ListItemText
                        primary={<Typography variant="subtitle1">Noreen Perez</Typography>}
                        secondary={<Typography variant="subtitle2">Updated Upcoming Events</Typography>}
                      />
                      <ListItemSecondaryAction sx={{ top: 30 }}>
                        <Grid container justifyContent="flex-end">
                          <Grid item>
